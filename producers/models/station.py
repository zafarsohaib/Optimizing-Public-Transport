...
class Station(Producer):
    ...
    def __init__(self, station_id, name, color, direction_a=None, direction_b=None):
        ...
        #
        #
        topic_name = f"org.chicago.cta.station.arrivals.v1" # TODO: Come up with a better topic name - done!
        super().__init__(
            topic_name,
    ...
    def run(self, train, direction, prev_station_id, prev_direction):
        ...
        #
        #
        #logger.info(f"arrival entry: {train}")
        ...
        logger.info(f"sent station data to kafka, id: {self.station_id}, train: {train.train_id}, status: {train.status.name}")
