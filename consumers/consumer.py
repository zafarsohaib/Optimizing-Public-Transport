...
class KafkaConsumer:
    ...
    def _consume(self):
        ...
        try:
            ...
            logger.error(f"Deserialize failure message {self.topic_name_pattern}:{r}")
            return 0
        ...
        logger.info(f"message received from {self.topic_name_pattern} {message.key()}: {message.value()}")
